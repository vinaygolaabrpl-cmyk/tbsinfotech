...
const PLANS = [
  ...
  { name: 'Silver', price: '$250', billing: 'Per Month', popular: true },
  { name: 'Gold', price: '$350', billing: 'Per Month' },
  { name: 'Platinum', price: '$450', billing: 'Per Month' }
];
    ...
    <div className="smo-packages-page">
      ...
      <section className="section">
        <div className="container">
          ...
          <PricingMatrix planColumnLabel="Activities" plans={PLANS} groups={GROUPS} ctaLabel="Order Now!" />
        </div>
      </section>
    </div>
  );
