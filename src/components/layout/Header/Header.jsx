    ...
    <header className="site-header">
      <div className="container inner">
        ...
        <div className="actions">
          <ThemeToggle />
          <a className="phone btn outline sm" href={siteConfig.whatsappLink} target='_blank'> {whatsappIcon}{siteConfig.phones[1]}</a>
          <Button to="/free-seo-audit" size="sm">Free SEO & GEO Audit</Button>
        </div>
      </div>
    </header>
  );
